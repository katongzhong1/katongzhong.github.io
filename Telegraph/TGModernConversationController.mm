...
typedef NS_ENUM(NSUInteger, TGModernConversationActivityChange) {
...
typedef NS_ENUM(NSUInteger, TGModernConversationPanelAnimation) {
...
- (instancetype)init {
    ...
    if (self != nil) {
        ...
        _avatarButton = [[TGModernConversationAvatarButton alloc] initWithFrame:CGRectMake(0, 0, 37, 37)];
